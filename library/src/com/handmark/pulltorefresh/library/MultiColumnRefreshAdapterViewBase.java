...
public abstract class MultiColumnRefreshAdapterViewBase<T extends PLA_AbsListView> extends PullToRefreshBase<T> implements
    ...
    public MultiColumnRefreshAdapterViewBase(Context context) {
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }

    public MultiColumnRefreshAdapterViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }

    public MultiColumnRefreshAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public MultiColumnRefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {

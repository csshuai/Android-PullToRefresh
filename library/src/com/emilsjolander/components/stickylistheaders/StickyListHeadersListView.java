...
public class StickyListHeadersListView extends ListView {
    ...
    private AdapterWrapper.OnHeaderClickListener mAdapterHeaderClickListener = new AdapterWrapper.OnHeaderClickListener() {
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            if (mOnHeaderClickListener != null) {
                mOnHeaderClickListener.onHeaderClick(StickyListHeadersListView.this, header, itemPosition, headerId,
                        false);
            }
        }
    };
    ...
    private int getSelectorPosition() {
        if (mSelectorPositionField == null) { // not all supported andorid version have
                                              // this variable
    ...
    private void scrollChanged(int reportedFirstVisibleItem) {
        ...
        if (childCount != 0) {
            ...
            if (viewToWatch != null && (viewToWatchIsFooter || viewToWatch.hasHeader())) {
                if (firstVisibleItem == listViewHeaderCount && super.getChildAt(0).getTop() > 0 && !mClippingToPadding) {
                    ...
                    mHeaderBottomPosition = mHeaderBottomPosition < paddingTop ? headerHeight + paddingTop
